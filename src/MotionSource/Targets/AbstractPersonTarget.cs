...
namespace ToySerialController.MotionSource
{
    public abstract class AbstractPersonTarget : IMotionSourceTarget
    {
        ...
        public void CreateUI(IUIBuilder builder)
        {
            ...
            TargetUpOffsetSlider = builder.CreateSlider("MotionSource:TargetOffset", "Target Up Offset (cm)", 0.0f, -0.15f, 0.15f, false, true, valueFormat: "P2");
            TargetForwardOffsetSlider = builder.CreateSlider("MotionSource:TargetForwardOffset", "Target Forward Offset (cm)", 0.0f, -0.05f, 0.05f, false, true, valueFormat: "P2");
