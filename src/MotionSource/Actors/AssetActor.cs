...
{
    public class AssetActor : IMotionSourceActor
    {
        ...
        public Vector3 ReferencePosition => _assetPosition;
        public Vector3 ReferenceUp => _assetUp;
        public Vector3 ReferenceRight => _assetRight;
        public Vector3 ReferenceForward => _assetForward;
        public float ReferenceLength => _assetLength;
        public float ReferenceRadius => _assetRadius;
        public Vector3 ReferencePlaneNormal => _assetUp;
